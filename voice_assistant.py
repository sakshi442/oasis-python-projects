...
def sendEmail(to, content):
    ...
    server.starttls()
    # Enter your email
    server.login('pranjalsonawane2365@gmail.com', 'codesownway0707')
    server.sendmail('pranjalsonawane2365@gmail.com', to, content)
    server.close()
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            speak(f"Sir/Ma'am , the current time is {strTime}")
        ...
        elif 'search in marathi for' in query:
